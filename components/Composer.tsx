      ...
      <Grid xs={12} md={3}>
        <Stack spacing={2}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <Button fullWidth variant='solid' color='danger' disabled={disableSend} onClick={handleSendClicked} >
              Chat
            </Button>
          </Box>

          <Stack direction='row' spacing={1} sx={{ ...hideOnMobile, flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'flex-start' }}>
